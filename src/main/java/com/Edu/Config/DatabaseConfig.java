...
//	 // 트랜잭션
//	 @Bean
//	 public DataSourceTransactionManager transactionManager(@Qualifier("eduDataSource") DataSource eduDataSource) {
//        DataSourceTransactionManager transactionManager = new DataSourceTransactionManager(eduDataSource);
//        transactionManager.setGlobalRollbackOnParticipationFailure(false);
//        return transactionManager;
//	 }
// 
